import ca.etsmtl.pegsolitaire.Evoker;
...
public class TestUnitEvoker {
    ...
    public static void setup() {
        ...
        successful    = Evoker.execute(movePeg);
    }
    ...
    @Nested
    @DisplayName("Testing move execute feature")
    class MoveExecuteFeature {
        @Test
        void sourceIsVacant() {
            try {
                ...
                assertEquals(true, isVacant.invoke(puzzle, new Integer[]{3, 5}));
        ...
        void neighbourIsVacant() {
            ...
            try {
                ...
                assertEquals(true, isVacant.invoke(puzzle, new Integer[]{neighbourX, neighbourY}));
        ...
        void destinationIsOccupied() {
            ...
            try {
                ...
                assertEquals(true, isOccupied.invoke(puzzle, new Integer[]{destinationX, destinationY}));
